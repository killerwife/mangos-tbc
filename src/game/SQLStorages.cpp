...
const char SpellDbcFmt[] = "iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiifiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiffffffiiiiiiiiiiiiiiiiiiiiifffiiiiiiiiiiiiiiifffiiiissssssssssssssssssssssssssssssssiiiiiiiiiifffiiiix";
...
SQLStorage sSpellStore(SpellDbcFmt, "id", "spell_dbc");
...
MANGOS_DLL_SPEC SQLStorage const* GetSpellStore() { return &sSpellStore; }
