...
enum TriggerCastFlags : uint32
{
    ...
    TRIGGERED_IGNORE_LINE_OF_SIGHT              = 0x00000008,   // Ignores IsWithinLOSInMap in CheckTarget and CheckCast
    // NOTE: due to existence of attribute for LOS ignore, usage must be carefully investigated, problem are spells that are cast from inside a cage TODO: investigate all occurences
