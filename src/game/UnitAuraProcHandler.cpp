...
SpellAuraProcResult Unit::HandleHasteAuraProc(Unit* pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const* /*procSpell*/, uint32 /*procFlag*/, uint32 /*procEx*/, uint32 cooldown)
{
    ...
    SpellEntry const* triggerEntry = sSpellStore.LookupEntry<SpellEntry>(triggered_spell_id);
        ...
        case SPELLFAMILY_SHAMAN:
        {
            switch (dummySpell->Id)
            {
                ...
                case 33757:
                {
                    ...
                    SpellEntry const* windfurySpellEntry = sSpellStore.LookupEntry<SpellEntry>(spellId);
...
SpellAuraProcResult Unit::HandleProcTriggerSpellAuraProc(Unit* pVictim, uint32 damage, Aura* triggeredByAura, SpellEntry const* procSpell, uint32 procFlags, uint32 procEx, uint32 cooldown)
{
        ...
        case SPELLFAMILY_PALADIN:
        {
            ...
            */
            ...
            else if (auraSpellInfo->SpellIconID == 241)
            {
                ...
                SpellEntry const* originalSpell = sSpellStore.LookupEntry<SpellEntry>(originalSpellId);
                if (!originalSpell)
                {
    ...
    SpellEntry const* triggerEntry = sSpellStore.LookupEntry<SpellEntry>(trigger_spell_id);
    if (!triggerEntry)
    {
